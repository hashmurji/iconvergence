                ...
                return(
                  <div key={c.id} onClick={()=>{setSelectedClient(c.id);setSection("clients");}}
                    ...
                    <div style={{display:"flex",gap:5,alignItems:"center",flexWrap:"wrap"}}>
                      <span style={{fontSize:11,fontWeight:600,color:posColor(t.pl)}}>{sign(t.pl)}{sym}{fmt(Math.abs(t.pl),0)}</span>
                      <span style={{fontSize:10,color:posColor(t.pctReturn),background:posBg(t.pctReturn),padding:"1px 5px",borderRadius:3,fontWeight:600}}>{pct(t.pctReturn)}</span>
                    </div>
